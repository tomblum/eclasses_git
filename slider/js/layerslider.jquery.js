(function($) {
		...
		ls.init = function(){
			...
			if( ls.o.navStartStop || ls.o.navButtons ){
				...
				if( ls.o.navButtons ){
                    ...
                    var bookmark=new Array("Home","Drys", "Wets","Rumrunners","Gangsters","Lawmen","Final"); 
					
					for(x=1;x<ls.g.layersNum+1;x++){

                        /* FJS - added id = x */ 
						$('<a id='+(bookmark[x-1])+' href=""></a>').appendTo( $(el).find('.ls-bottom-slidebuttons') ).click(function(e){
							e.preventDefault();
	...
	layerSlider.options = {
		...
		autoStart			: false,						// If true, slideshow will automatically start after loading the page.
		...
		skin				: 'darkskin',				// You can change the skin of the Slider, use 'noskin' to hide skin and buttons.
		skinsPath			: '/slider/skin/',	// You can change the default path of the skins folder. Note, that you must use the slash at the end of the path.
		...
		yourLogo			: true,					// This is a fixed image that will be shown above of LayerSlider container. For example if you want to display your own logo, etc. You have to add the correct path to your image file.
